  ...
  return (
    <div>
      <div className="max-w-[400px] mx-auto min-h-[600px] px-4 py-20">
        ...
        {error ? <p className="bg-red-500">{error}</p> : null}
        <form onSubmit={handleSubmit}>
          <div className="my-4">
            ...
            <div className="my-2 w-full relative rounded-2xl shadow-xl">
              ...
              <AiOutlineMail className="absolute right-2 top-3 text-accent" />
            </div>
          </div>
          <div className="my-4">
            ...
            <div className="my-2 w-full relative rounded-2xl shadow-xl">
              ...
              <AiFillLock className="absolute right-2 top-3 text-accent" />
            </div>
          </div>
          <button className="w-full my-2 p-3 bg-button text-btnText rounded-2xl shadow-xl">Sign Up</button>
        </form>

        <p className="my-4"><Link to="/signin" className="text-accent underline underline-offset-2"> Already have an account </Link></p>
