  ...
  return (
    <div className="rounded-div my-12 py-8">
      <div className="flex py-8">
        ...
        <div>
          <p className="text-3xl font-extrabold">{coin?.name} Price</p>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div>
          <div className="flex justify-between">
            {coin.market_data?.current_price ? (<p className="text-3xl font-semibold">${coin.market_data.current_price.usd.toLocaleString()}</p>) : null}
            <p>7 days</p>
          </div>
          <div>
      ...
      <div>
        <p className="text-xl font-extrabold">Market Stats</p>
        <div className="flex justify-between py-4">
          <div>
      ...
      <div className="py-4">
        <p className="text-xl font-extrabold">About {coin.name}</p>
